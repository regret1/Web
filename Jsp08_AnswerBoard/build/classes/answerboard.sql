...
INSERT INTO ANSWERBOARD VALUES(BOARDNOSQ.NEXTVAL, GROUPNOSQ.NEXTVAL, 1,0,'첫번째 글','1번 글 입니다.', '유저1',CURRENT_DATE);
INSERT INTO ANSWERBOARD VALUES(BOARDNOSQ.NEXTVAL, GROUPNOSQ.NEXTVAL, 1,0,'두번째 글','2번 글 입니다.', '유저2',CURRENT_DATE);
...
--세번째 글 작성
INSERT INTO ANSWERBOARD VALUES(BOARDNOSQ.NEXTVAL,GROUPNOSQ.NEXTVAL,1,0,'세번째 글','3번 글 입니다아아.','유저3',CURRENT_DATE);
...
INSERT INTO ANSWERBOARD VALUES(BOARDNOSQ.NEXTVAL,
	...
	'RE:두번째 글','2글에 답글입니다~','유저1',CURRENT_DATE 
);
...
INSERT INTO ANSWERBOARD VALUES(BOARDNOSQ.NEXTVAL, 
	...
	(SELECT GROUPSQ FROM ANSWERBOARD WHERE BOARDNO=2)+1,
	(SELECT TITLETAB FROM ANSWERBOARD WHERE BOARDNO=2)+2,
	'RE:두번째 글에 답변그을', '2번글에 답글입니다!!', '유저2',CURRENT_DATE
);

SELECT * FROM ANSWERBOARD
ORDER BY GROUPNO DESC, GROUPSQ ;

--답변 작성(RE:두번째 글, BOARDNO=8)
--1.UPDATE
UPDATE ANSWERBOARD SET GROUPSQ = GROUPSQ +1
...
INSERT INTO ANSWERBOARD VALUES(BOARDNOSQ.NEXTVAL,
	...
	(SELECT TITLETAB FROM ANSWERBOARD WHERE BOARDNO=8)+2,
	'RE:RE:두번째글','2번글 답글에 답글~~~~~~~~~','유저3',CURRENT_DATE 
);
